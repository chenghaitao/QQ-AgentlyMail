...
> 📌 **v2.1.1 更新：**
> - 🐛 修复 `mail-helper.mjs` 在 Linux/nvm 下 `resolveAgentlyEntry()` 路径推导 bug
>   - Method 2 (`which`): 修正 `bin/node_modules/` → `../lib/node_modules/`
>   - Method 3 (`npm prefix -g`): 修正 `node_modules/` → `lib/node_modules/`
>   - 新增多布局探测，兼容 nvm / system-global / flat 安装
...
- **本地开发：** `D:\qq-agently-mail\assets\mail-helper.mjs`
